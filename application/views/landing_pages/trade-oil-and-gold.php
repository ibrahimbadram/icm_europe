...
<section id="iq-home" class="iq-banner overview-block-pt iq-bg iq-bg-fixed iq-over-blue-90" style="background: url(assets/registration/images/bg/camp_6july2018-bg.png);">
  <div class="container-2">
  <div class="full-width"> 
<input type="hidden" id="telephonecodeval" >
<form id="tc-lead-registration" >
       <? if ( $this->lg == 'ar' ) { ?>
    <input data-tc-field="field" type="hidden" id="Campaign:Referrer URL"  name="campaign_id" value="1531730967-ar"/>
            <? } else { ?>
    <input data-tc-field="field" type="hidden" id="Campaign:Referrer URL"  name="campaign_id" value="1531730967"/>
      <? } ?>
    <input data-tc-field="field" type="hidden" id="Campaign:Campaign ID" name="campaign_name" value="Trade Oil & Gold <?=$this->lg?>"/>
  <div class="three-full-width margin-top-28">
      <div class="banner-text">
          <div class="full-width">
              <h2 class="form__title <? if ( $this->lg == 'ar' ) { ?>navy-color<? } else { ?>white-color<? } ?> margin-bottom-2-30 full-width">
                <? if ( $this->lg == 'ar' ) { ?>
              سجِّل الآن...<br>
وتداول مع وسيط يتمتع بموثوقية عالمية. 
           ...
           الاسم الأول 
              ...
              <? } ?>
                  ...
                  <div class="input-tooltip input-tooltip_first_name input-tooltip_error" style="display:none" >P
                      <? if ( $this->lg == 'ar' ) { ?>
...
foreach ($contries as $row){
 ...
 ?>
    ...
    <div class="seven-full-width margin-top-50-2 text-align-center">
      <div class="full-width">
      <h1 class="text-align-center navy-color full-width margin-bottom-30" style="line-height:31px ; font-size:30px" >
      <? if ( $this->lg == 'ar' ) { ?>
      تداول الآن في النفط  و 
      <? } else { ?>
      Trade Oil & 
      <? } ?>
      <span style="text-shadow: 2px 2px #FCC95D;color:#e7c142" ><? if ( $this->lg == 'ar' ) { ?>
                   الذهب
              <? } else { ?>
      GOLD
              <? } ?></span> 
 ...
 &quot; as low as $2,000 &quot;
      ...
      <div class=" full-width">
        <div class="full-width">
          ...
          <img class="banner-img" src="assets/registration/images/banner/gold-min.png" alt=""> 
            </div>
        </div>
        </div>
