  ...
  <div class="navbar navbar-default navbar-fixed-top menu-top">
    <div class="container-2">
      ...
      <a href="tel:00442074425610">
        <div class="iq-footer-box text-left">
          <div class="iq-icon"> <i aria-hidden="true" class="ion-ios-telephone-outline" style="font-size:30px"></i> </div>
...
<section id="iq-home" class="iq-banner overview-block-pt iq-bg iq-bg-fixed iq-over-blue-90" style="background: url(assets/registration/images/bg/00000.jpg);">
  <div class="container-2">
...
وتداول مع وسيط يتمتع بموثوقية عالمية. 
              <? } else { ?>
              Sign Up to Start Trading <br>with a Reliable Broker
              <? } ?>
              </h2>
...
foreach ($contries as $row){
 ...
 ?>
    ...
    <div class="seven-full-width margin-top-50-2 text-align-center full-height">
      ...
      <h1 class="text-align-center white-color  margin-bottom-30 middle-text margin-top-180 shadow-all"  >
       <? if ( $this->lg == 'ar' ) { ?>
