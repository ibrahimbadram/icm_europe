...
<form id="tc-lead-registration" >
      <? if ( $this->lg == 'ar' ) { ?>
    <input data-tc-field="field" type="hidden" id="Campaign:Referrer URL" name="campaign_id" value="1531730966-ar"/>
            <? } else { ?>
    <input data-tc-field="field" type="hidden" id="Campaign:Referrer URL"  name="campaign_id" value="1531730966"/>
      <? } ?>
    <input data-tc-field="field" type="hidden" id="Campaign:Campaign ID" name="campaign_name" value="Trade Currencies <?=$this->lg?>"/>
  <div class="three-full-width margin-top-28">
      <div class="banner-text">
          <div class="full-width">
              <h2 class="form__title navy-color margin-bottom-2-30 full-width">
              <? if ( $this->lg == 'ar' ) { ?>
              سجِّل الآن...<br>
    ...
    <div class="seven-full-width margin-top-50-2 text-align-center">
      ...
      <h1 class="text-align-center white-color full-width margin-bottom-30" style="line-height:31px ; font-size:30px" >
       <? if ( $this->lg == 'ar' ) { ?>
              ...
              <? } else { ?>
      Trade currencies Now!
              <? } ?>
 <br><small class="white-color">
 <? if ( $this->lg == 'ar' ) { ?>
 ...
 &quot; as low as $1,000 &quot;
      ...
      <div class=" full-width">
        <div class="full-width">
          ...
          <img class="banner-img" src="assets/registration/images/banner/currencies.png" alt=""> 
            </div>
        </div>
        </div>
