      ...
      <div class="uk-grid uk-margin-medium-top">
         <div class="uk-width-1-1@l uk-width-1-1@m uk-width-1-1@s">
            <div class="layout__body">
               <div class="section">
                  <div class="grid">
                     <div class="col-12">
                        <h1>
                           <center>
                              <?=$this->sm->getword('Secure Account Opening', $this->lg)?>
                           </center>
                        </h1>
                     </div>
                  </div>
               ...
               <?php echo form_open('#', 'class="email" id="open_an_account-form"');?>
               <div>
                  <?php /*<h3>
                     <?=$this->sm->getword('Create your profile', $this->lg)?> 
                  </h3>
                  */ ?>
                  <?php $this->load->view('account-real-step1')?>
