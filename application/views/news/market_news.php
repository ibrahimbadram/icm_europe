          ...
          <div class="container">
            ...
            <div >
              <div class="col-md-12 col-xs-12">
				<!--h2>
				<? echo $check['title_'.$this->lg] ?> </h2-->
                <div class="control-rte">					
                     <article class="uk-article idz-article">						
                     <p class="uk-article-meta">									
                     <span class="uk-label uk-label-success">							
					 <?=$check['sub_title_'.$this->lg]?>									
                     </span> 									
					 <? echo $check['date_'.$this->lg]?>								
                     </p>								
                     ...
                     <img class="uk-margin-bottom news-list-img" src="<? echo 'uploads/market_news/1980x1280/'.$check['image']?>" alt="">
					<? echo $check['description_'.$this->lg]?>
					</article>
                </div>
              </div>
            </div>
