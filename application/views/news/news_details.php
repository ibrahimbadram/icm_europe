      ...
      <div class="section uk-margin-medium-bottom">
        <div class="grid">
          <div class="col-12">
            <h1>
              <center>
                 <? echo $this->sm->getcontent('about_us/news/'.$id,'title_'.$this->lg)?>
              </center>
            </h1>
          </div>
        </div>
            ...
            <div >
              <div class="col-md-12 col-xs-12">
                ...
                <div class="control-rte">					
                     <article class="uk-article idz-article">						<p class="uk-article-meta">									<span class="uk-label uk-label-success">							<?=$this->sm->getcontent('About_us/news/'.$id,'sub_title_'.$this->lg)?>									</span> 									<? echo $this->sm->getcontent('About_us/news/'.$id,'date_'.$this->lg)?>								</p>								<?/*<h3 class="uk-margin-small-top"><a class="uk-link-reset" href="<?=site_url('news/details/'.$id)?>"><? echo $this->sm->getcontent('About_us/news/'.$id,'title_'.$this->lg)?></a>								</h3>*/?>
                       
						 <img class="uk-margin-bottom news-list-img" src="<? echo 'uploads/pages/1980x1280/'.$this->sm->getcontent('about_us/news/'.$id,'image')?>" alt="">
						<? echo $this->sm->getcontent('about_us/news/'.$id,'description_'.$this->lg)?>
					</article>
