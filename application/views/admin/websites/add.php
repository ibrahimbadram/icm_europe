...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <i class="fa fa-users"></i> websites Management <small>Add / Edit websites</small> </h1>
  </section>
    ...
    <div class="row"> 
      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-primary">
          ...
          <form id="addForm" action="<?php echo site_url() ?>/admin/websites/addNewrow" enctype="multipart/form-data" method="post" role="form">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
