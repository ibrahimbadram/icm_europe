...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <i class="fa fa-pagess"></i> pages Management <small>Add / Edit pages</small> </h1>
  </section>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <? if ( $image ) { ?>
                    <span><a  class="example-image-link" data-lightbox="example-1" data-title="<?php echo $title ?>" href="<?php echo base_url() ?>uploads/pages/<?php echo $image; ?>" > show image</a> | <a onclick="delete_image('<?php echo $id?>')" class="cursor" >Delete image</a></span>
                    <? } ?>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <? if ( $file ) { ?>
                    <span><a  class="example-image-link"    target="_blank" href="<?php echo base_url() ?>uploads/pages/<?php echo $file; ?>" > show file</a> | <a onclick="delete_file('<?php echo $id?>')" class="cursor">Delete file</a></span>
                    <? } ?>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="form-control required" id="website" name="website" title="website">
                      ...
                      <option value="2" <?php if($website == 2) {echo "selected=selected";} ?>>www.cimtrader.com.vc</option>
                    </select>
                  </div>
                </div>
              </div>
