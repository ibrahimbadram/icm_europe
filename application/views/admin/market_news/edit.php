...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <i class="fa fa-market_newss"></i> market_news Management <small>Add / Edit market_news</small> </h1>
  </section>
    ...
    <div class="row"> 
      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-primary">
          ...
          <form action="<?php echo site_url() ?>/admin/market_news/editrow" enctype="multipart/form-data" method="post" id="editForm" role="form">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <? if ( $image ) { ?>
                    <span><a  class="example-image-link" data-lightbox="example-1" data-title="<?php echo $title ?>" href="<?php echo base_url() ?>uploads/market_news/<?php echo $image; ?>" > show image</a> | <a onclick="delete_image('<?php echo $id?>')" class="cursor" >Delete image</a></span>
                    <? } ?>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <? if ( $file ) { ?>
                    <span><a  class="example-image-link"    target="_blank" href="<?php echo base_url() ?>uploads/market_news/<?php echo $file; ?>" > show file</a> | <a onclick="delete_file('<?php echo $id?>')" class="cursor">Delete file</a></span>
                    <? } ?>
                  </div>
                </div>
              </div>
