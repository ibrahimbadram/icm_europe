    ...
    <div class="row"> 
      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-primary">
          ...
          <form action="<?php echo site_url() ?>/admin/category_gallery/editrow" enctype="multipart/form-data" method="post" id="editForm" role="form">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="form-control required" id="website" name="website" title="website">
					  ...
					  ?>
                      <option value="<?=$webs->id?>" <?php if($website == $webs->id) {echo "selected=selected";} ?>><?=$webs->title?></option>
					<?	} ?>
                    </select>
					<?	} ?>
                  </div>
