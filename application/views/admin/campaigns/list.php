        ...
        <div class="row">
            ...
            <div class="col-xs-12 text-right">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-primary" href="<?php echo site_url(); ?>/admin/campaigns/addNew"><i class="fa fa-plus"></i> Add New</a>
              ...
              <div class="box">
                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        ...
                        <form action="<?php echo site_url() ?>/admin/campaigns/Listing" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr class="cursor" id="<?php echo $record->id ?>">
                      ...
                      <td><?php echo $record->campaign_id ?></td>

                      <td><?php if (  $record->active == 1 ) { echo 'YES'; } else { echo 'NO'; } ?></td>

                      <td class="text-center">

                          <a class="btn btn-sm btn-info" href="<?php echo site_url().'/admin/campaigns/editOld/'.$record->id; ?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets/js/admin/campaigns.js" charset="utf-8"></script>
