...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-groupss"></i> groups Management
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo site_url(); ?>/admin/groups/addNew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo site_url() ?>/admin/groups/Listing" method="POST" id="searchList">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr class="cursor" id="<?php echo $record->id ?>">
                      ...
                      <td class="text-center">
                          <a class="btn btn-sm btn-info" href="<?php echo site_url().'/admin/groups/editOld/'.$record->id; ?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets/js/admin/groups.js" charset="utf-8"></script>
