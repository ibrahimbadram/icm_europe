                ...
                <div class="control-rte">
                  <div class="uk-grid">
					...
					<div class="uk-width-1-1@s mobile-only">
							...
							<?=$this->sm->getcontent('About_us/news/'.$i,'sub_title_'.$this->lg)?>									
                            </span> 									
							<? echo $this->sm->getcontent('About_us/news/'.$i,'date_'.$this->lg)?>								
                            </p>								
                            <h3 class="uk-margin-small-top"><a class="uk-link-reset" href="<?=site_url('news/details/'.$i)?>"><? echo $this->sm->getcontent('About_us/news/'.$i,'title_'.$this->lg)?></a>								
                            </h3>								
