...
<meta name="description" content="ICM.com" />
...
<form id="tc-lead-registration" >
  ...
  <div class="three-full-width margin-top-28" style="margin:30px auto ; float:none">
...
<? $this->load->view('other_forms/include1')?>
<script>
...
$.post("<?=site_url('registration/signup_user_phone')?>",{first_name:$('#first_name').val(),last_name:$('#last_name').val(),email:$('#email').val(),country:$('#addr_country').val(),telephone:$('#telephone').val(),captcha:$('#g-recaptcha-response').val()}, function(data) {
	if ( data == 1 ) {
//sendtoicm();
