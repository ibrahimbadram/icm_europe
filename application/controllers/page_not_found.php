...
class Page_not_found extends CI_Controller {
    ...
    public function index($title='') {
        ...
        $data = array();
		$breadcrumb['breadcrumb'] = array(0=>array('link'=>'home','title'=>$this->sm->getword('home',$this->lg)),1=>array('link'=>'#','title'=>'404'),2=>array('link'=>'#','title'=>''));
		$this->template->content->view('breadcrumb', $breadcrumb);
        $this->template->content->view('404', $data);
