...
class open_real_account_model extends CI_Model
{
    /**
    ...
    function ListingCount($searchText = '')
    {
        ...
        $this->db->from('tbl_open_real_account as BaseTbl');
 ...
 function Listing_foreign($table)
    ...
    function addNewrow($regulationsInfo)
    {
        ...
        $this->db->insert('tbl_open_real_account', $regulationsInfo);
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_open_real_account');
    ...
    {
        $this->db->where('id', $id);
        $this->db->update('tbl_open_real_account', $regulationsInfo);
