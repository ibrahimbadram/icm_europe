...

{
...

    {
		...
		$this->db->where('BaseTbl.category_gal', $this->uri->segment(5));
    ...
    function Listing($searchText = '', $page, $segment, $category_gal=0)

    {
		...
		$category_gal = ($category_gal == 0)? $this->uri->segment(5) : $category_gal;
		$this->db->where('BaseTbl.category_gal', $this->uri->segment(5));
 ...
 function Listing_foreign($table)
    ...
    function addNewrow($galleryInfo)

    {

        $this->db->trans_start();

		//print_r($galleryInfo);exit;
     ...
     * @param array $galleryInfo : This is market_news updated information

     * @param number $id : This is market_news id

     */

    function editrow($galleryInfo, $id)
    ...
    function deleterow($id, $galleryInfo)
