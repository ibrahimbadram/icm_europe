...

{
...

    {
        ...
        $this->db->from('tbl_market_news as BaseTbl');
 ...
 function Listing_foreign($table)
    ...
    function addNewrow($market_newsInfo)

    {

        $this->db->trans_start();

		//print_r($market_newsInfo);exit;

        $this->db->insert('tbl_market_news', $market_newsInfo);
     ...
     * @param array $market_newsInfo : This is market_news updated information

     * @param number $id : This is market_news id

     */

    function editrow($market_newsInfo, $id)

    {

        $this->db->where('id', $id);

        $this->db->update('tbl_market_news', $market_newsInfo);
    ...
    function deleterow($id, $market_newsInfo)
