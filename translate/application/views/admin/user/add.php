    ...
    <div class="row"> 
      ...
      <div class="col-md-8"> 
        ...
        <div class="box box-primary">
          ...
          <form role="form" id="addUser" action="<?php echo site_url() ?>/admin/user/addNewrow" method="post" role="form">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control required" id="role" name="role" onchange="checkrole(this.value)" >
              ...
              <div class="col-md-12 list_groups" style="display:none" >

                <div class="form-group">

                  <label for="group">Group</label>

                  <select  class="form-control list_group" id="group"  name="group" >
