...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <h1> <i class="fa fa-users"></i> User Management <small>Add / Edit User</small> </h1>
    ...
    <div class="row"> 
      ...
      <div class="col-md-8"> 
        ...
        <div class="box box-primary">
          ...
          <form role="form" action="<?php echo site_url() ?>/admin/user/editrow" method="post" id="editrow" role="form">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fname" placeholder="Full Name" name="fname" value="<?php echo $name; ?>" >
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="role" name="role" onchange="checkrole(this.value)" >
              ...
              <div class="col-md-12 list_groups" <?php if($roleId < 3 ) { ?>  style="display:none" <? } ?> >

                <div class="form-group">

                  <label for="group">Group</label>

                  <select  class="form-control list_group <?php if($rl->roleId > 2 ) { ?>  required <? } ?>" id="group"  name="group" >
                  ...
                  <option value="" >Select please </option>
...

                    {
                        ...
                        foreach($groupstbl as $group )

                        {	

                    ?>

                    <option value="<?php echo $group->id ?>" <? if ( $group->id == $usergroup ) {  ?> selected="selected" <? } ?> ><?php echo $group->title ?></option>
